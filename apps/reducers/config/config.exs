...
config :reducers, Perhap.Scheduler,
  jobs: [
    ...
    [name: "bin_audit_event", schedule: "* */12 * * *", task: {Service.Cron, :bin_audit_event, []}], #every 12 hours
    [name: "actuals_event", schedule: "* */4 * * *", task: {Service.Cron, :actuals_event, []}], # every 4 hours
